...
const ticTacToe = (row, column) => {
  ...
  // check to see if the current space is NOT already occupied. If so, then:
  // put the playerTurn marker (whether X or O) at chosen row and column 
  
  if (board[row][column] === ' ') {
    board[row][column] = playerTurn
    } else {
      return 'You cannot play on an occupied space!!'
    }
